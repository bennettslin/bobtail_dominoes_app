...
Of course, it was obvious all along that Bobtail Dominoes could be a tabletop game for multiple players. So I play tested with some musician friends, and we came up with a set of rules that worked well. My hope is that a few of you will invent your own variants and share them, just like with classic dominoes!
                `,
            ],
        }}
    />
