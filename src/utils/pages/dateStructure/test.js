import { flattenDateStructuredPages, parseDateStructuredPages } from '.'

const PARSED_DATED_STRUCTURED_PAGES = [
    {
        2021: [
            {
                11: [
...
describe('parseDateStructuredPages', () => {
    it('returns dated-structured pages', () => {
        expect(
        ...
        ).toStrictEqual(PARSED_DATED_STRUCTURED_PAGES)
    })
})
...
describe('flattenDateStructuredPages', () => {
    it('returns flattened date-structured pages', () => {
        expect(
            flattenDateStructuredPages(PARSED_DATED_STRUCTURED_PAGES),
        ).toStrictEqual([
            {
                context: {
                    pageMap: {
